...
table_three_aftersplit <- table_before_aux %>%
...
table_after_split_details <- load_all_tables(folder_details, patt="splitting") 
...
table_three_sites_latex <- kableExtra::kable(table_three_aftersplit %>% select(-SPLIT_Max.Target, -contains("Calls"), -contains("SPLIT")), booktabs = TRUE, align = "r")

table_three_calls_latex <- kableExtra::kable(table_three_aftersplit %>% select(-SPLIT_Max.Target, -contains("Sites"), -contains("SPLIT")), booktabs = TRUE, align = "r")
...
table_after_split_details_latex <- kableExtra::kable(table_after_split_details %>% select(-Benchmark), booktabs = TRUE, align = "r")

############################################## LATEX MACROS GENERATION ##############################################
@

\def\BlocksGeneralMetrics{%
<<BlocksGeneralMetrics, echo=FALSE, results='asis'>>=
print(table_one_latex)
  @
  }%
  
\def\BlocksBeforeAfterSplitCalls{%
<<BlocksBeforeAfterSplitCalls, echo=FALSE, results='asis'>>=
print(table_three_calls_latex)
  @
  }%

\def\BlocksBeforeAfterSplitSites{%
<<BlocksBeforeAfterSplitSites, echo=FALSE, results='asis'>>=
print(table_three_sites_latex)
  @
  }%
  
\def\BlocksExtent{%
<<BlocksExtent, echo=FALSE, results='asis'>>=
print(table_four_latex)
  @
  }%

\def\BlocksSplittingTransitions{%
<<BlocksSplittingTransitions, echo=FALSE, results='asis'>>=
print(table_split_transitions_latex)
  @
  }%
  
\def\BlocksPolyAfterSplitting{%
<<BlocksPolyAfterSplitting, echo=FALSE, results='asis'>>=
print(table_after_split_details_latex)
  @
  }%
