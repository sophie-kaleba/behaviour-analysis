...
data <- load_data_file("./results/AsciidoctorConvertSmall_Apr26-2022_11:32:52/parsed_AsciidoctorConvertSmall.mylog")
data <- as_tibble(data)
benchmark_name <- "asci"
...
compute_before_after <- function(df, cache_status_int, call_or_site) {
  ...
  return ( df[cache_status,row_call_site][[call_or_site]] )
}
...
write_on_disk <- function(df, name, path = "") {
 write.table(df,paste(benchmark_name, name,".csv",sep="-"), col.names = FALSE, row.names = FALSE) 
}
...
tp_calls_mono <- c(benchmark_name, before, after, compute_evolution(before, after))
...
tp_calls_poly <- c(benchmark_name, before, after, compute_evolution(before, after))
...
tp_calls_mega <- c(benchmark_name, before, after, compute_evolution(before, after))
...
tp_call_sites_mono <- c(benchmark_name, before, after, compute_evolution(before, after))
...
tp_call_sites_poly <- c(benchmark_name, before, after, compute_evolution(before, after))
...
tp_call_sites_mega <- c(benchmark_name, before, after, compute_evolution(before, after))
...
split_calls_mono <- c(benchmark_name, before, after, compute_evolution(before, after))
...
split_calls_poly <- c(benchmark_name, before, after, compute_evolution(before, after))
...
split_calls_mega <- c(benchmark_name, before, after, compute_evolution(before, after))
...
split_call_sites_mono <- c(benchmark_name, before, after, compute_evolution(before, after))
...
split_call_sites_poly <- c(benchmark_name, before, after, compute_evolution(before, after))
...
# it augmented by x%
split_call_sites_mega <- c(benchmark_name, before, after, compute_evolution(before, after))

############################################## SAVE AS CSV ###############################################  
write_on_disk(tp_calls_mono, "tp_calls_mono")
write_on_disk(tp_calls_poly, "tp_calls_poly")
write_on_disk(tp_calls_mega, "tp_calls_mega")

write_on_disk(tp_call_sites_mono, "tp_call_sites_mono")
write_on_disk(tp_call_sites_poly, "tp_call_sites_poly")
write_on_disk(tp_call_sites_mega, "tp_call_sites_mega")

write_on_disk(split_calls_mono, "split_calls_mono")
write_on_disk(split_calls_poly, "split_calls_poly")
write_on_disk(split_calls_mega, "split_calls_mega")

write_on_disk(split_call_sites_mono, "split_call_site_mono")
write_on_disk(split_call_sites_poly, "split_call_site_poly")
write_on_disk(split_call_sites_mega, "split_call_site_mega")
