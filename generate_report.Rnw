...
table_after_tp_details_latex <- kableExtra::kable(table_after_tp_details, booktabs = TRUE, align = "r")

table_after_split_details_latex <- kableExtra::kable(table_after_split_details, booktabs = TRUE, align = "r")
