...
#folder_out <- "/home/sopi/Documents/Side_projects/behaviour-analysis/test_new_scripts"
...
dt_write_on_disk(table_two_spliting, "table_two_spliting", file.path(folder_out,"Details"))