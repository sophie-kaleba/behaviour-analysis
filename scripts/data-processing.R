...
load_data_file_old <- function (file, row_names, version = 0, sha = "") {
...
load_phase_data <- function (file, row_names, version = 0, sha = "") {
  if (missing(row_names)) {
    # these row names are hard coded and might not be applicable
    # names like this are generated by ReBench
    row_names <- c("Source Identifier",	"Call Target",	"Method name" )
  }
...
load_data_file_new <- function (file, row_names, version = 0, sha = "") {
  if (missing(row_names)) {
    # these row names are hard coded and might not be applicable
    # names like this are generated by ReBench
    row_names <- c("Invocation", "Iteration", "Value", "Unit", "Criterion",
...
load_gc_file_new <- function (file, row_names, version = 0, sha = "") {
  if (missing(row_names)) {
    # these row names are hard coded and might not be applicable
    # names like this are generated by ReBench
    row_names <- c("Cause", "Occurence", "Start", "Duration", "HeapBefore", "HeapAfter",
                   "Type", "End")
  }
