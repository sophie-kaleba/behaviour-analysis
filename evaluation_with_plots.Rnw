...
print(xtable(summary_splitting, type = "latex"), include.rownames=FALSE, tabular.environment="longtable", floating=FALSE)
      @
  }%

\def\SplittingDetails{%
<<SplittingDetails, echo=FALSE, results='asis'>>=
print(xtable(summary_splitting_detail_turbo, type = "latex"), include.rownames=FALSE, tabular.environment="longtable", floating=FALSE)
      @
  }%
