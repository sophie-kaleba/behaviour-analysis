...
table_one <- before %>%
  select(Benchmark, Num.LOC, LOC.Cov, Num.Fn, Fn.Cov, Max.Target, Mono.Call.Sites, Mono.Calls, Poly.Call.Sites, Poly.Calls, Mega.Call.Sites, Mega.Calls, Total.Calls, Freq.Poly.Calls, Total.Call.Sites, Freq.Poly.Call.Sites) 
...
table_one_latex <- kableExtra::kable(table_one %>% apply_big_numbers() %>% add_percent(c("Freq.Poly.Calls", "Freq.Poly.Call.Sites")) %>% select(-Max.Target, -Mono.Call.Sites, -Mono.Calls, -Poly.Call.Sites, -Poly.Calls, -Mega.Call.Sites, -Mega.Calls), booktabs = TRUE, align = "r", escape = TRUE, linesep=c(""))

table_two_sites_latex <- kableExtra::kable(table_two_aftertp %>% apply_big_numbers() %>% add_percent(c("Change.Poly.Call.Sites", "Change.Mega.Call.Sites")) %>% select(-Max.Target, -TP_Max.Target, -contains("Mono"), -contains("Calls"), -contains("TP")), booktabs = TRUE, align = "r", linesep=c("")) %>% kableExtra::kable_styling(latex_table_env="tabularx")

table_two_calls_latex <- kableExtra::kable(table_two_aftertp %>% apply_big_numbers() %>% add_percent(c("Change.Poly.Calls", "Change.Mega.Calls")) %>% select(-Max.Target, -TP_Max.Target, -contains("Mono"), -contains("Sites"), -contains("TP")), booktabs = TRUE, align = "r", linesep=c("")) %>% kableExtra::kable_styling(latex_table_env="tabularx")

table_three_sites_latex <- kableExtra::kable(table_three_aftersplit %>% apply_big_numbers() %>% add_percent(c("Change.Poly.Call.Sites", "Change.Mega.Call.Sites")) %>% select(-SPLIT_Max.Target, -TP_Max.Target, -contains("Mono"), -contains("Calls"), -contains("SPLIT")), booktabs = TRUE, align = "r", linesep=c("")) %>% kableExtra::kable_styling(latex_table_env="tabularx")

table_three_calls_latex <- kableExtra::kable(table_three_aftersplit %>% apply_big_numbers() %>% add_percent(c("Change.Poly.Calls", "Change.Mega.Calls")) %>% select(-SPLIT_Max.Target, -TP_Max.Target, -contains("Mono"), -contains("Sites"), -contains("SPLIT")), booktabs = TRUE, align = "r", linesep=c("")) %>% kableExtra::kable_styling(latex_table_env="tabularx")

table_four_latex <- kableExtra::kable(table_four_max, booktabs = TRUE, align = "r", linesep=c(""))

table_split_transitions_latex <- kableExtra::kable(table_split_transitions, booktabs = TRUE, align = "r", linesep=c(""))
